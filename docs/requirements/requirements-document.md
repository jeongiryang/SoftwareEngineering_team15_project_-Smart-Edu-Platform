...
본 문서는 회의록, 잠재 사용자 인터뷰, 서비스 의뢰자/이해관계자 관점 분석, AI 기반 가상 인터뷰 시뮬레이션 결과를 바탕으로 고객 관점 요구사항, 기능 요구사항, 비기능 요구사항, 유스케이스 후보를 정리한다.
...
| 고객 관점 요구사항 ID | 요구사항명 | 설명 | 관련 페르소나 |
|---|---|---|---|
...
요구사항 추적표는 최종 사용자·시스템 직접 사용자 관점과 서비스 의뢰자·이해관계자 관점으로 구분해 요구사항의 출처와 연결 관계를 정리한다.

## 8.1 최종 사용자 및 시스템 직접 사용자 요구사항 추적표

| 페르소나 ID | 사용자 그룹 | 고객 관점 요구사항 ID | 기능/비기능 요구사항 ID | 유스케이스 ID |
|---|---|---|---|---|
...
| 페르소나 ID | 이해관계자 유형 | 고객 관점 요구사항 ID | 기능/비기능 요구사항 ID | 유스케이스 ID |
|---|---|---|---|---|
