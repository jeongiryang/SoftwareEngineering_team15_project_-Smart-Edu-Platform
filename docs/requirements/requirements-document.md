...
- [유스케이스 다이어그램 이미지](../../screenshots/usecase-diagram.png): 렌더링된 유스케이스 다이어그램 이미지
...
본 문서에서는 회의록, 사용자 인터뷰, AI 기반 가상 인터뷰 시뮬레이션 결과를 바탕으로 사용자 요구사항, 기능 요구사항, 비기능 요구사항, 유스케이스 후보를 정리한다.
...
2. 사용자 그룹 분류
3. 페르소나 설정
4. AI 기반 가상 인터뷰 및 설문조사 진행
5. 사용자 문제점 및 핵심 니즈 정리
6. 사용자 요구사항 도출
7. 기능 요구사항 및 비기능 요구사항 정리
8. 유스케이스 후보 도출
9. 설계 문서와 테스트 문서에서 활용할 요구사항 ID 부여
