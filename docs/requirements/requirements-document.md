...
3. [요구사항 도출 대상 및 페르소나 요약](#3-요구사항-도출-대상-및-페르소나-요약)
4. [관점별 요구사항](#4-관점별-요구사항)
   - [4.1 잠재적 실사용자 요구사항](#41-잠재적-실사용자-요구사항)
...
8. [요구사항 추적표](#8-요구사항-추적표)
   - [8.1 잠재적 실사용자 및 관리자 요구사항 추적표](#81-잠재적-실사용자-및-관리자-요구사항-추적표)
   - [8.2 서비스 의뢰자 및 이해관계자 관점 추적표](#82-서비스-의뢰자-및-이해관계자-관점-추적표)
9. [부록 문서](#9-부록-문서)
...
본 문서는 회의록, 잠재적 실사용자 인터뷰, 서비스 의뢰자 및 이해관계자 관점 분석, AI 기반 가상 인터뷰 시뮬레이션 결과를 바탕으로 잠재적 실사용자 요구사항, 서비스 의뢰자 및 이해관계자 요구사항, 기능 요구사항, 비기능 요구사항, 유스케이스 후보를 정리한다.

본 문서에서 **잠재적 실사용자**는 Smart Edu Platform을 실제로 사용할 가능성이 있는 학습자 집단을 의미한다. **서비스 의뢰자 및 이해관계자**는 서비스를 기획·의뢰·운영·관리·보안 검토·사업화하는 사람 또는 조직을 의미하며, 시스템 직접 액터가 아니라 요구사항 도출 근거 제공자이다.
...
- 잠재적 실사용자, 서비스 의뢰자 및 이해관계자 정의
- 요구사항 도출 근거
- 잠재적 실사용자 요구사항
- 서비스 의뢰자 및 이해관계자 요구사항
- 기능 요구사항
- 비기능 요구사항
- 유스케이스
- 요구사항 추적 관계
...
| ID 유형 | 의미 | 예시 |
|---|---|---|
| `P` | 페르소나(잠재적 실사용자, 서비스 의뢰자 및 이해관계자) | `P-01` |
| `UR` | 관점별 요구사항 | `UR-01` |
| `FR` | 기능 요구사항 | `FR-01` |
| `NFR` | 비기능 요구사항 | `NFR-01` |
| `UC` | 유스케이스 | `UC-01` |
...
본 프로젝트에서는 잠재적 실사용자의 학습 불편과 니즈, 서비스 의뢰자 및 이해관계자의 운영성·확장성·보안성·사업성 요구를 함께 반영하기 위해 다음 방식으로 요구사항을 도출하였다.

| 도출 방법 | 설명 |
|---|---|
| 회의 기반 분석 | 조원 회의를 통해 주제 선정, 구현 방향, 기능 후보를 정리 |
| AI 기반 가상 인터뷰 | 다양한 잠재적 실사용자 집단을 대상으로 한 가상 설문/인터뷰 시뮬레이션 수행 |
| 서비스 의뢰자 및 이해관계자 관점 분석 | 서비스 의뢰자 및 이해관계자 관점에서 운영성, 확장성, 수요, 관리 기능, 보안 요구 확인 |
| 페르소나 분석 | 대표 잠재적 실사용자와 서비스 의뢰자 및 이해관계자를 설정하고 관점별 핵심 니즈와 요구 기능 도출 |
| 문서 분석 | 과제 안내 자료와 프로젝트 요구사항을 분석하여 필수 구현 범위 확인 |
| 워크샵 | 조원 간 기능 우선순위와 구현 가능성을 논의 |
| 사용자 스토리 및 시나리오 | 잠재적 실사용자의 사용 흐름과 서비스 의뢰자 및 이해관계자의 운영 시나리오를 기능 요구사항으로 확장 |
...
2. 잠재적 실사용자 그룹 분류
3. 페르소나 설정
4. AI 기반 잠재적 실사용자 인터뷰 및 설문조사 진행
5. 서비스 의뢰자 및 이해관계자 관점 분석
6. 잠재적 실사용자 문제점 및 핵심 니즈 정리
7. 잠재적 실사용자 요구사항과 서비스 의뢰자 및 이해관계자 요구사항 도출
...
# 3. 요구사항 도출 대상 및 페르소나 요약

## 3.1 잠재적 실사용자 그룹

| 잠재적 실사용자 그룹 | 핵심 니즈 | 대표 기능 |
|---|---|---|
...
| 페르소나 ID | 잠재적 실사용자 그룹 | 이름 | 나이 | 공부 대상 | 핵심 니즈 |
|---|---|---|---:|---|---|
...
잠재적 실사용자 인터뷰와 서비스 의뢰자 및 이해관계자 인터뷰는 요구사항 도출의 서로 다른 근거이다. 서비스 의뢰자 및 이해관계자 관점은 새 기능 추가가 아니라 기존 요구사항의 타당성, 우선순위, 운영성, 확장성, 보안성을 검토하기 위한 요구사항 도출 근거로 사용한다.

인터뷰 규모는 다음과 같이 정리한다.

| 구분 | 규모 | 목적 |
|---|---:|---|
| 잠재적 실사용자 인터뷰 | 7개 잠재적 실사용자 그룹 × 15명 | 잠재적 실사용자 니즈와 기능 우선순위 확인 |
...
서비스 의뢰자 및 이해관계자는 시스템을 직접 사용하는 주액터가 아니라 운영·기획·보안·사업 관점의 **요구사항 도출 근거**를 제공한다. 따라서 `P-08`~`P-13`은 잠재적 실사용자 페르소나가 아니라 서비스 의뢰자 및 이해관계자 페르소나이며, 특히 `P-11` 학습 플랫폼 관리자는 유스케이스의 `관리자` 액터가 수행하는 기능 요구의 운영 근거를 제공할 뿐 유스케이스 다이어그램의 새 액터를 의미하지 않는다.

| 관점 ID | 서비스 의뢰자 및 이해관계자 유형 | 역할 | 핵심 목표 | 주요 요구 | 우려 사항 | 연결 요구사항 |
|---|---|---|---|---|---|---|
...
4장은 **잠재적 실사용자 요구사항**과 **서비스 의뢰자 및 이해관계자 요구사항**을 구분하여 정리한다. 잠재적 실사용자 요구사항은 실제 학습자가 시스템에서 기대하는 기능과 품질을 나타내며, 서비스 의뢰자 및 이해관계자 요구사항은 새 유스케이스 액터를 추가하기 위한 항목이 아니라 운영·기획·보안·사업 관점에서 기존 FR/NFR/UC의 필요성과 우선순위를 보강하는 근거이다.

## 4.1 잠재적 실사용자 요구사항

잠재적 실사용자 요구사항은 실제 학습자가 시스템에서 기대하는 기능과 품질을 정리한 항목이다. 잠재적 실사용자 인터뷰 시뮬레이션과 페르소나 `P-01`~`P-07`을 근거로 한다.

| 요구사항 ID | 요구사항명 | 설명 | 관련 페르소나 |
|---|---|---|---|
| UR-01 | 사용자 인증 | 사용자는 자신의 계정을 생성하고 로그인할 수 있어야 한다. | 전체 잠재적 실사용자 |
...
| UR-12 | 데이터 보호 | 사용자는 자신의 개인정보와 학습 데이터를 안전하게 보호받을 수 있어야 한다. | 전체 잠재적 실사용자 |
...
다음 요구사항은 [서비스 의뢰자 인터뷰 시뮬레이션 문서](./ai-client-interview-simulation.md)를 근거로 도출한 **서비스 의뢰자 및 이해관계자 관점**의 운영·기획·보안·사업 요구사항이다. `UR-15`~`UR-20`은 기존 FR/NFR/UC의 필요성, 우선순위, 운영 기준을 보강하기 위한 요구사항이다. `P-08`~`P-13`은 서비스 의뢰자 및 이해관계자 페르소나이며 **시스템 직접 액터가 아님**을 전제로 한다.
...
|---|---|---|---|---|
| FR-01 | 회원가입/로그인 | 사용자는 아이디와 비밀번호를 통해 회원가입 및 로그인을 할 수 있어야 한다. | 아이디, 비밀번호, 이름 | 프로필 이미지, 학습 목적 |
| FR-02 | 사용자 프로필 관리 | 시스템은 사용자 정보를 저장하고, 사용자가 자신의 학습 목적과 기본 정보를 수정할 수 있도록 해야 한다. | 사용자 ID, 이름, 아이디 | 학습 목표, 프로필 이미지, 사용자 유형 |
...
| NFR-09 | 확장성 | 기능 모듈화 | 향후 새로운 학습 유형과 잠재적 실사용자 그룹을 추가할 수 있도록 기능을 모듈화해야 한다. |
...
요구사항 추적표는 잠재적 실사용자 및 관리자 요구사항과 서비스 의뢰자 및 이해관계자 요구사항을 구분하여 요구사항의 출처와 연결 관계를 정리한다.

## 8.1 잠재적 실사용자 및 관리자 요구사항 추적표

| 페르소나 ID | 대상 유형 | 요구사항 ID | 기능/비기능 요구사항 ID | 유스케이스 ID |
|---|---|---|---|---|
...
| 전체 잠재적 실사용자 | 공통 | UR-01 | FR-01, FR-02 | UC-01, UC-02 |
| 전체 잠재적 실사용자 | 공통 | UR-12 | NFR-02, NFR-03, NFR-07 | - |
| 관리자 | 공통 | - | FR-27 | UC-18 |
| 관리자 | 공통 | - | FR-28 | UC-20 |
| 관리자 | 공통 | - | FR-29 | UC-21 |

## 8.2 서비스 의뢰자 및 이해관계자 관점 추적표

다음 표는 서비스 의뢰자 및 이해관계자 관점에서 도출한 운영·기획·보안·사업 요구사항과 기존 FR/NFR/UC의 연결 관계를 나타낸다. 8.1의 `관리자` 행은 시스템을 직접 사용하는 관리자 액터 기준의 기능 요구사항이며, 8.2의 `P-11`은 해당 관리자 기능의 운영 필요성을 설명하는 이해관계자 페르소나이다. 이는 유스케이스 다이어그램에 새 액터를 추가한다는 의미가 아니다.

| 페르소나 ID | 이해관계자 유형 | 요구사항 ID | 기능/비기능 요구사항 ID | 유스케이스 ID |
|---|---|---|---|---|
...
- 요구사항 도출 근거
  - [잠재적 실사용자 인터뷰 시뮬레이션 문서](./ai-user-interview-simulation.md)
