...
4. [잠재적 실사용자 요구사항과 서비스 의뢰자 및 이해관계자 요구사항](#4-잠재적-실사용자-요구사항과-서비스-의뢰자-및-이해관계자-요구사항)
...
# 4. 잠재적 실사용자 요구사항과 서비스 의뢰자 및 이해관계자 요구사항

4장은 **잠재적 실사용자 요구사항**과 **서비스 의뢰자 및 이해관계자 요구사항**을 구분하여 정리한다. 잠재적 실사용자 요구사항은 실제 학습자가 시스템에서 기대하는 기능과 품질을 나타내며, 서비스 의뢰자 및 이해관계자 요구사항은 운영·기획·보안·사업 관점에서 기존 FR/NFR/UC의 필요성과 우선순위를 보강하는 근거이다.
