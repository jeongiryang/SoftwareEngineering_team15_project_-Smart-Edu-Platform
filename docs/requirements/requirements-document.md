...
3. [잠재적 실사용자 그룹 및 페르소나 요약](#3-잠재적-실사용자-그룹-및-페르소나-요약)
4. [잠재적 실사용자 및 서비스 의뢰자·이해관계자 요구사항](#4-잠재적-실사용자-및-서비스-의뢰자이해관계자-요구사항)
...
8. [요구사항 추적표](#8-요구사항-추적표)
   - [8.1 잠재적 실사용자 및 시스템 직접 사용자 요구사항 추적표](#81-잠재적-실사용자-및-시스템-직접-사용자-요구사항-추적표)
...
| `UR` | 요구사항(잠재적 실사용자, 서비스 의뢰자 및 이해관계자 관점) | `UR-01` |
| `FR` | 기능 요구사항 | `FR-01` |
| `NFR` | 비기능 요구사항 | `NFR-01` |
| `UC` | 유스케이스 | `UC-01` |
...
| 서비스 의뢰자 및 이해관계자 관점 분석 | 서비스를 기획·의뢰·운영·관리·보안 검토·사업화하는 이해관계자 관점에서 운영성, 확장성, 수요, 관리 기능, 보안 요구 확인 |
...
| 사용자 스토리 및 시나리오 | 잠재적 실사용자 입장에서 필요한 기능을 기능 요구사항으로 확장 |
...
잠재적 실사용자 인터뷰와 서비스 의뢰자 및 이해관계자 인터뷰는 요구사항 도출의 서로 다른 근거이다. 서비스 의뢰자 및 이해관계자 관점은 새 기능 추가가 아니라 기존 요구사항의 타당성, 우선순위, 운영성, 확장성, 보안성을 검토하기 위한 보조 근거로 사용한다.
...
# 4. 잠재적 실사용자 및 서비스 의뢰자·이해관계자 요구사항

4장은 **잠재적 실사용자 요구사항**과 **서비스 의뢰자 및 이해관계자 요구사항**을 구분하여 정리한다. 잠재적 실사용자 요구사항은 실제 학습자가 시스템에서 기대하는 기능과 품질을 나타내며, 서비스 의뢰자 및 이해관계자 요구사항은 운영·기획·보안·사업 관점에서 기존 FR/NFR/UC의 필요성과 우선순위를 보강하는 근거이다. 이 요구사항은 새 유스케이스 액터를 추가하기 위한 항목이 아니다.
...
다음 요구사항은 [서비스 의뢰자 인터뷰 시뮬레이션 문서](./ai-client-interview-simulation.md)를 근거로 도출한 **서비스 의뢰자 및 이해관계자 관점**의 운영·기획·보안·사업 요구사항이다. `UR-15`~`UR-20`은 새 유스케이스 액터를 추가하기 위한 항목이 아니라 기존 FR/NFR/UC의 필요성, 우선순위, 운영 기준을 보강하기 위한 요구사항이다. `P-08`~`P-13`은 서비스 의뢰자 및 이해관계자 페르소나이며 **시스템 직접 액터가 아님**을 전제로 한다.
...
요구사항 추적표는 잠재적 실사용자 및 시스템 직접 사용자 관점과 서비스 의뢰자 및 이해관계자 관점으로 구분하여 요구사항의 출처와 연결 관계를 정리한다.

## 8.1 잠재적 실사용자 및 시스템 직접 사용자 요구사항 추적표
...
다음 표는 서비스 의뢰자 및 이해관계자 관점에서 도출한 운영·기획·보안·사업 요구사항과 기존 FR/NFR/UC의 연결 관계를 나타낸다. `P-11` 학습 플랫폼 관리자는 운영 이해관계자 페르소나이며, 유스케이스의 `관리자` 액터가 수행하는 기능 요구의 운영 근거를 제공한다. 이는 유스케이스 다이어그램에 새 액터를 추가한다는 의미가 아니다.
