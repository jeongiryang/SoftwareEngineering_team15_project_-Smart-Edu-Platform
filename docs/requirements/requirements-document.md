...
7. [요구사항 추적표](#7-요구사항-추적표)
8. [유스케이스 다이어그램](#8-유스케이스-다이어그램)
...
본 문서는 표준의 모든 항목을 그대로 적용하는 문서가 아니라, 과제 범위에 맞춰 요구사항 도출 근거, 고객 및 이해관계자 정의, 사용자 요구사항, 기능 요구사항, 비기능 요구사항, 유스케이스, 요구사항 추적 관계를 중심으로 정리함.
...
| 관점 | 주요 확인 내용 | 기존 요구사항 연결 |
|---|---|---|
| 공식 의뢰자 | 전 연령층을 포괄하는 학습 관리 플랫폼 필요 | FR-23 |
| 서비스 기획자 | 사용자 유형별 기능 우선순위와 MVP 범위 정리 | FR-23 |
...
사용자 요구사항은 사용자 관점에서 시스템에 기대하는 기능과 품질을 정리한 것이다.
...
요구사항 추적표는 페르소나, 사용자 요구사항, 기능/비기능 요구사항, 유스케이스 간의 연결 관계를 나타낸다.
