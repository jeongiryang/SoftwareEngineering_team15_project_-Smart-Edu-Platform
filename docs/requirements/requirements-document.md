...
4. [잠재적 실사용자 및 서비스 의뢰자 관점 요구사항](#4-잠재적-실사용자-및-서비스-의뢰자-관점-요구사항)
...
본 문서는 회의록, 잠재적 실사용자 인터뷰, 서비스 의뢰자/이해관계자 관점 분석, AI 기반 가상 인터뷰 시뮬레이션 결과를 바탕으로 잠재적 실사용자 요구사항, 서비스 의뢰자 및 이해관계자 요구사항, 기능 요구사항, 비기능 요구사항, 유스케이스 후보를 정리한다.

본 프로젝트의 요구사항 도출 대상은 Smart Edu Platform을 실제로 사용할 **잠재적 실사용자**와, 서비스를 기획·의뢰·운영·관리·보안 검토·사업화하는 **서비스 의뢰자 및 이해관계자**로 구분한다. 잠재적 실사용자는 실제 시스템을 사용하는 학습자 집단이며, 서비스 의뢰자 및 이해관계자는 시스템 직접 액터가 아니라 운영·기획·보안·사업 관점의 요구사항 근거 제공자이다.
...
| ID 유형 | 의미 | 예시 |
|---|---|---|
| `P` | 페르소나(잠재적 실사용자 및 서비스 의뢰자/이해관계자) | `P-01` |
| `UR` | 요구사항(잠재적 실사용자 및 서비스 의뢰자/이해관계자 관점) | `UR-01` |
| `FR` | 기능 요구사항 | `FR-01` |
| `NFR` | 비기능 요구사항 | `NFR-01` |
| `UC` | 유스케이스 | `UC-01` |
...
| 서비스 의뢰자/이해관계자 관점 분석 | 서비스를 기획·의뢰·운영·관리·보안 검토·사업화하는 이해관계자 관점에서 운영성, 확장성, 수요, 관리 기능, 보안 요구 확인 |
| 페르소나 분석 | 대표 잠재적 실사용자와 서비스 의뢰자/이해관계자를 설정하고 관점별 핵심 니즈와 요구 기능 도출 |
...
7. 잠재적 실사용자 및 서비스 의뢰자/이해관계자 요구사항 도출
...
잠재적 실사용자 인터뷰와 서비스 의뢰자/이해관계자 인터뷰는 요구사항 도출의 서로 다른 근거이다. 서비스 의뢰자 및 이해관계자 관점은 새 기능 추가가 아니라 기존 요구사항의 타당성, 우선순위, 운영성, 확장성, 보안성을 검토하기 위한 보조 근거로 사용한다.
...
서비스 의뢰자 및 이해관계자는 시스템을 직접 사용하는 주액터가 아니라 **요구사항 도출 근거**를 제공하는 운영 관점 이해관계자이다. 따라서 아래 `P-08`~`P-13`은 유스케이스 다이어그램의 액터가 아니라 의뢰자/이해관계자 페르소나로 사용한다.

`P-08`~`P-13`은 잠재적 실사용자 페르소나가 아니라 서비스 운영·기획·보안·사업 관점의 요구사항 근거를 제공하는 페르소나이다. 특히 `P-11` 학습 플랫폼 관리자는 유스케이스의 `관리자` 액터와 관련된 운영 요구를 제공하지만, 유스케이스 다이어그램의 새 액터를 의미하지 않는다.
...
# 4. 잠재적 실사용자 및 서비스 의뢰자 관점 요구사항

4장은 **잠재적 실사용자 요구사항**과 **서비스 의뢰자 및 이해관계자 요구사항**을 분리하여 정리한다. 잠재적 실사용자 요구사항은 실제 학습자가 시스템에서 기대하는 기능과 품질이며, 서비스 의뢰자 및 이해관계자 요구사항은 운영·기획·보안·사업 관점에서 기존 FR/NFR/UC의 필요성과 우선순위를 보강하는 근거이다.
...
다음 요구사항은 [서비스 의뢰자 인터뷰 시뮬레이션 문서](./ai-client-interview-simulation.md)를 근거로 도출한 운영·기획·보안·사업 관점 요구사항이다. `UR-15`~`UR-20`은 새 유스케이스 액터를 추가하기 위한 항목이 아니라 기존 FR/NFR/UC의 필요성, 우선순위, 운영 기준을 보강하기 위한 요구사항이다. `P-08`~`P-13`은 의뢰자/이해관계자 페르소나이며 **시스템 직접 액터가 아님**을 전제로 한다.
...
요구사항 추적표는 잠재적 실사용자·시스템 직접 사용자 관점과 서비스 의뢰자·이해관계자 관점으로 구분해 요구사항의 출처와 연결 관계를 정리한다.
...
다음 표는 서비스 운영·기획·보안·사업 관점에서 도출한 요구사항과 기존 FR/NFR/UC의 연결 관계를 나타낸다. `P-11` 학습 플랫폼 관리자는 운영 이해관계자 페르소나이며, 유스케이스의 `관리자` 액터가 수행하는 기능 요구의 운영 근거를 제공한다. 이는 유스케이스 다이어그램에 새 액터를 추가한다는 의미가 아니다.
