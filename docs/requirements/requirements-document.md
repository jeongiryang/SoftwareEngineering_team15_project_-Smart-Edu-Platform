...
사용자 요구사항은 사용자 관점에서 시스템에 기대하는 기능과 품질을 정리한 것이다. 본 문서의 고객 개념은 최종 사용자뿐 아니라 서비스를 기획·의뢰·운영·관리하는 사람 또는 조직까지 포함하므로, 최종 사용자 요구사항과 의뢰자/이해관계자 요구사항을 함께 관리한다.
...
다음 요구사항은 서비스 의뢰자 및 이해관계자 관점에서 도출한 운영·기획·보안·사업 요구사항이다. 새 기능을 임의로 추가하기 위한 항목이 아니라 기존 FR/NFR/UC의 필요성과 우선순위를 보강하는 근거로 사용한다.
